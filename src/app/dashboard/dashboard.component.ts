...
// Add To Wishlist / Remove from wishlist
 recommendNews(event,index,selectedNews) : void {
       ...
       this.newsService.recommendNews(this.favNewsId,this.userService.token).subscribe(
               data =>{
 ...
 ngOnInit(): void {
      this.newsService.getAllNews(this.userService.token)
              .subscribe(news => {
                  this.news = news;
                ...
                if(this.userId==undefined){
                  ...
                  this.newsService.getAllWishListNews(this.userService.token)
                  .subscribe(news => {
